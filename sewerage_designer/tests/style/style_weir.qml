...
<qgis version="3.16.10-Hannover" hasScaleBasedVisibilityFlag="1" readOnly="0" simplifyLocal="1" simplifyDrawingHints="0" minScale="10000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" labelsEnabled="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" fontLetterSpacing="0" fontStrikeout="0" fontSizeUnit="Point" fontItalic="0" namedStyle="Standaard" textColor="0,0,0,255" capitalization="0" previewBkgrdColor="255,255,255,255" blendMode="0" fontUnderline="0" fontKerning="1" fontSize="8" fieldName="'Ditch_lvl: \n'|| &quot;ditch_level&quot;" allowHtml="0" isExpression="1" textOrientation="horizontal" fontWeight="50" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="MS Shell Dlg 2" fontWordSpacing="0" textOpacity="1">
        <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferNoFill="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0"/>
        <text-mask maskSizeUnits="MM" maskedSymbolLayers="" maskOpacity="1" maskEnabled="0" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSize="1.5" maskJoinStyle="128"/>
        <background shapeOpacity="1" shapeType="0" shapeBorderWidth="0" shapeFillColor="255,255,255,255" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetY="0" shapeBorderColor="128,128,128,255" shapeRadiiY="0" shapeSVGFile="" shapeRotationType="0" shapeRadiiX="0" shapeBlendMode="0" shapeRadiiUnit="MM" shapeSizeUnit="MM" shapeOffsetUnit="MM" shapeSizeType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeOffsetX="0" shapeSizeX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeJoinStyle="64" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM">
        ...
        <shadow shadowUnder="0" shadowOffsetDist="1" shadowScale="100" shadowRadiusAlphaOnly="0" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowDraw="0" shadowRadius="1.5" shadowRadiusUnit="MM" shadowBlendMode="6" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetAngle="135" shadowOpacity="0.7" shadowOffsetGlobal="1"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" addDirectionSymbol="0" wrapChar="" multilineAlign="3" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" formatNumbers="0" decimals="3" plussign="0" rightDirectionSymbol=">"/>
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="1.75" yOffset="0" lineAnchorPercent="0.5" maxCurvedCharAngleIn="25" placement="0" xOffset="6" centroidWhole="0" offsetType="0" repeatDistanceUnits="MM" distUnits="MM" fitInPolygonOnly="0" preserveRotation="1" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" priority="5" centroidInside="0" lineAnchorType="0" placementFlags="10" offsetUnits="MM" overrunDistance="0" polygonPlacementFlags="2" geometryGeneratorType="PointGeometry" geometryGeneratorEnabled="0" repeatDistance="0"/>
      <rendering obstacle="1" obstacleFactor="1" obstacleType="1" displayAll="0" fontLimitPixelSize="0" scaleMin="0" fontMinPixelSize="3" labelPerPart="0" upsidedownLabels="0" scaleMax="2500" minFeatureSize="0" limitNumLabels="0" fontMaxPixelSize="10000" mergeLines="0" zIndex="0" maxNumLabels="2000" scaleVisibility="1" drawLabels="1"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="weir_level" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="7" name="" field="weir_level"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="weir_level" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="weir_level" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="weir_level" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
  </attributeactions>
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;overstortende_straal&quot;">
    <columns>
      ...
      <column hidden="0" name="weir_level" width="-1" type="field"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="weir_level" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="delta_H" labelOnTop="0"/>
    <field name="ditch_level" labelOnTop="0"/>
    <field name="fid" labelOnTop="0"/>
    <field name="freeboard" labelOnTop="0"/>
    <field name="hydraulic_head" labelOnTop="0"/>
    <field name="minimum_freeboard" labelOnTop="0"/>
    <field name="overstortende_straal" labelOnTop="0"/>
    ...
    <field name="weir_level" labelOnTop="0"/>
  </labelOnTop>
