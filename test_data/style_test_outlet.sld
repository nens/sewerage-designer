...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" version="1.1.0">
  <NamedLayer>
    <se:Name>style_test_outlet</se:Name>
    <UserStyle>
      <se:Name>style_test_outlet</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#f706e7</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            <se:Label>
              <!--SE Export for 'Ditch_lvl: \n' || ditch_level not implemented yet-->Placeholder</se:Label>
            <se:Font>
            ...
            <se:LabelPlacement>
              <se:PointPlacement>
                ...
                <se:Displacement>
                  <se:DisplacementX>4.24</se:DisplacementX>
                  <se:DisplacementY>4.24</se:DisplacementY>
                </se:Displacement>
              </se:PointPlacement>
            </se:LabelPlacement>
            <se:Fill>
            ...
            <se:VendorOption name="maxDisplacement">7</se:VendorOption>
          </se:TextSymbolizer>
        </se:Rule>
      </se:FeatureTypeStyle>
    </UserStyle>
